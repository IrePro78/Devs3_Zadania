...
async function main3() {
    try {
      ...
      // Jeśli test się powiedzie, kontynuujemy z główną logiką
      ...
      const actors = [
        ...
        { name: 'Lolek', birthYear: 1960 },
        { name: 'Franek', birthYear: 1960 },
        { name: 'Pikolo', birthYear: 1960 },
        { name: 'Fikus', birthYear: 1960 }
      ];
      ...
      const actedIn = [
        ...
        { actor: 'Lolek', movie: 'The Matrix', character: 'Agent Smith' },
