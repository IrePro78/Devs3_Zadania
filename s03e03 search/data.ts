export const data = [
    ...
    },
    {
      ...
      isbn: "978-0-73521-350-9"
    },
    {
      author: "Jim Collins",
      title: "Good to Great",
      text: 'Good to Great: "Implementing ETO and embracing BHAGs can significantly accelerate an organization\'s journey from good to great."',
      isbn: "978-0-06-662099-4"
    },
    {
      author: "Simon Sinek",
      title: "Leaders Eat Last",
      text: 'Leaders Eat Last: "Understanding the importance of OKRs and fostering psychological safety are key elements of effective leadership in the VUCA world."',
      isbn: "978-1-59184-559-2"
    },
  ];